          ...
          <div class="flex items-center gap-2 sm:gap-2.5 min-w-0 flex-1">
            ...
            <div class="min-w-0 flex-1">
              <div class="flex items-center gap-1.5 flex-wrap">
                ...
                <span class="hidden sm:inline-block text-[9px] font-semibold uppercase tracking-wider text-orange-800/80 dark:text-orange-300/80 bg-orange-100/70 dark:bg-orange-950/60 px-1.5 py-0.2 rounded">${catMeta.label}</span>
              </div>
