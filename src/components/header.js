      ...
      <div class="bg-amber-50/90 border-2 border-sfl-cardBorder rounded-xl p-3.5 text-xs text-sfl-wood space-y-2.5 shadow-sm">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-1.5 border-b border-sfl-cardBorder/50 pb-2">
          <p class="font-bold flex items-center gap-1.5 text-sfl-wood text-sm">
            <span>📖</span> How to Track Your Harvests
          </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 text-[11px] font-medium text-sfl-woodLight">
          <div class="bg-white/60 p-2.5 rounded-lg border border-sfl-cardBorder/40 space-y-1">
            <span class="font-bold text-sfl-dirt block">Step 1: Link Farm</span>
            <p>Enter your <strong>Farm ID</strong> at the top of the calculator and click <strong>Sync Inventory Now</strong>.</p>
          </div>
          <div class="bg-white/60 p-2.5 rounded-lg border border-sfl-cardBorder/40 space-y-1">
            <span class="font-bold text-sfl-dirt block">Step 2: Save Baseline</span>
            <p>Before harvesting, click <strong>🚩 1. Save Pre-Harvest Stock</strong> to record your starting amounts.</p>
          </div>
          <div class="bg-white/60 p-2.5 rounded-lg border border-sfl-cardBorder/40 space-y-1">
            <span class="font-bold text-sfl-dirt block">Step 3: Calculate Earnings</span>
            <p>After harvesting, add items to your basket and click <strong class="text-sfl-green">🏁 2. Calculate Harvest Yield</strong>.</p>
          </div>
        </div>
      </div>
    </div>
